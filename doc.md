...
| `asBoolean(...)` | Treat each of the values passed as argumemts as `true^^xsd:boolean` and all else as `false^^xsd:boolean`. The string match is case-sensitive (unlike the no-args version of the transformer).                                                                                                                                                                                                                                                                                                                        
